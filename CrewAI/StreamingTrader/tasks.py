...
class StrategyParameters(BaseModel):
    rsi_buy_threshold: int = Field(description="RSI threshold to trigger a BUY decision. Typically 25-35. Must be an integer.")
    rsi_sell_threshold: int = Field(description="RSI threshold to trigger a SELL decision. Typically 65-75. Must be an integer.")
...
strategy_optimization_task = Task(
    ...
    Guidelines:
    1. Align optimization decisions with the user's trading sensitivity profile ({sensitivity_profile}):
