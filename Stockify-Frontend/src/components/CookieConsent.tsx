...
const CookieConsent: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const consent = localStorage.getItem('stockify_cookie_consent');
    if (!consent) {
      setIsVisible(true);
    }
  }, []);
  ...
  const handleAccept = () => {
    try {
      localStorage.setItem('stockify_cookie_consent', 'true');
      setIsVisible(false);
    } catch (e) {
      ...
      <div className="cookie-modal">
        ...
        {isCookieDisabled ? (
          <>
            ...
            <p>
              Stockify requires cookies to function properly. 
          ...
          <>
            ...
            <p>
              To provide the best trading experience, Stockify uses cookies to personalize content and analyze traffic. 
